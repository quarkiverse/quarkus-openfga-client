...
a| [[quarkus-openfga-client_quarkus-openfga-max-connections]] [.property-path]##link:#quarkus-openfga-client_quarkus-openfga-max-connections[`+++quarkus.openfga.max-connections+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.openfga.max-connections+++[]
endif::add-copy-button-to-config-props[]
...
Controls the size of the HTTP connection pool the client maintains for the OpenFGA endpoint. Increase this to allow more concurrent in-flight requests to the server.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPENFGA_MAX_CONNECTIONS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPENFGA_MAX_CONNECTIONS+++`
endif::add-copy-button-to-env-var[]
--
|int
|`+++5+++`
...
a| [[quarkus-openfga-client_quarkus-openfga-shared-key]] [.property-path]##link:#quarkus-openfga-client_quarkus-openfga-shared-key[[.line-through]#`+++quarkus.openfga.shared-key+++`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.openfga.shared-key+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
_This property is deprecated since `3.1.0`._

Shared authentication key.

This property is deprecated and will be removed in a future release, use `Credentials.Preshared++#++key()` instead.
...
a|icon:lock[title=Fixed at build time] [[quarkus-openfga-client_quarkus-openfga-devservices-container-env-environment-variable-name]] [.property-path]##link:#quarkus-openfga-client_quarkus-openfga-devservices-container-env-environment-variable-name[`+++quarkus.openfga.devservices.container-env."environment-variable-name"+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.openfga.devservices.container-env."environment-variable-name"+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPENFGA_DEVSERVICES_CONTAINER_ENV__ENVIRONMENT_VARIABLE_NAME_+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPENFGA_DEVSERVICES_CONTAINER_ENV__ENVIRONMENT_VARIABLE_NAME_+++`
endif::add-copy-button-to-env-var[]
--
|Map<String,String>
|

a|icon:lock[title=Fixed at build time] [[quarkus-openfga-client_quarkus-openfga-devservices-reuse]] [.property-path]##link:#quarkus-openfga-client_quarkus-openfga-devservices-reuse[`+++quarkus.openfga.devservices.reuse+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.openfga.devservices.reuse+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPENFGA_DEVSERVICES_REUSE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPENFGA_DEVSERVICES_REUSE+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
